...
if __name__ == '__main__':
    # main()
    detpath = os.path.join(r'/home/dingjian/jianding/code/RoITransformer/output/rcnn/DOTA/resnet_v1_101_dota_light_head_best_point_trainval_rcnn_end2end_deform_real_psroi_v3/test/Task1_results_0.1_nms') + '/Task1_{:s}.txt'
    annopath = r'/home/dingjian/jianding/code/RoITransformer/data/test/labelTxt/{:s}.txt'
    imagesetfile = r'/home/dingjian/jianding/code/RoITransformer/data/test/testset.txt'
