...
class FPNPSROIPooling_v2Operator(mx.operator.CustomOp):
    def __init__(self, feat_strides, pooled_height, pooled_width, output_dim, pooling_mode):
...
@mx.operator.register('fpn_psroi_pooling_v2')
class FPNPSROIPooling_v2Prop(mx.operator.CustomOpProp):
    def __init__(self, feat_strides='(4,8,16,32)', pooled_height='7', pooled_width='7', pooling_mode='alignave', output_dim='10'):
        super(FPNPSROIPooling_v2Prop, self).__init__(need_top_grad=True)
    ...
    def create_operator(self, ctx, shapes, dtypes):
        return FPNPSROIPooling_v2Operator(self.feat_strides, self.pooled_height, self.pooled_width, self.output_dim, self.pooling_mode)
