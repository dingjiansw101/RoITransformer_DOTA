...
class resnet_v1_101_fpn_rcnn_rotbox_light_head(Symbol):
    def __init__(self):
        """
    ...
    def get_symbol(self, cfg, is_train=True):
        ...
        # if cfg.network.RPN_THIN_FEATRUE == True:
        #     # large separable
        ...
        #     fpn_p6_new = self.get_light_head(fpn_p6, 'p6')
        #
        #     rpn_cls_score_p2, rpn_prob_p2, rpn_bbox_loss_p2, rpn_bbox_pred_p2 = self.get_rpn_subnet(fpn_p2_new, cfg.network.NUM_ANCHORS, 'p2')
        #     rpn_cls_score_p3, rpn_prob_p3, rpn_bbox_loss_p3, rpn_bbox_pred_p3 = self.get_rpn_subnet(fpn_p3_new, cfg.network.NUM_ANCHORS, 'p3')
        #     rpn_cls_score_p4, rpn_prob_p4, rpn_bbox_loss_p4, rpn_bbox_pred_p4 = self.get_rpn_subnet(fpn_p4_new, cfg.network.NUM_ANCHORS, 'p4')
        #     rpn_cls_score_p5, rpn_prob_p5, rpn_bbox_loss_p5, rpn_bbox_pred_p5 = self.get_rpn_subnet(fpn_p5_new, cfg.network.NUM_ANCHORS, 'p5')
        #     rpn_cls_score_p6, rpn_prob_p6, rpn_bbox_loss_p6, rpn_bbox_pred_p6 = self.get_rpn_subnet(fpn_p6_new, cfg.network.NUM_ANCHORS, 'p6')
        # else:
        # large separable
        fpn_p2_new = self.get_light_head(fpn_p2, 'p2')
        fpn_p3_new = self.get_light_head(fpn_p3, 'p3')
        ...
        roi_pool = mx.symbol.Custom(data_p2=fpn_p2_new, data_p3=fpn_p3_new, data_p4=fpn_p4_new, data_p5=fpn_p5_new,
                                        rois=rois, op_type='fpn_psroi_pooling_v2', name='fpn_psroi_pooling_v2', pooling_mode=cfg.network.POOLING_MODE)

        # light head
        fc_new_2 = mx.symbol.FullyConnected(name='fc_new_2', data=roi_pool, num_hidden=2048)
        ...
        if is_train:
            ...
            bbox_pred = mx.sym.Reshape(data=bbox_pred, shape=(cfg.TEST.BATCH_IMAGES, -1, 5 * num_reg_classes), name='bbox_pred_reshape')
